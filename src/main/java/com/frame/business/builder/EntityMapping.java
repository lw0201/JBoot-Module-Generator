...
public enum EntityMapping {
	...
	/**
	 * Indicates that the SQL type is database-specific and gets mapped to a Java
	 ...
	 *         value will be the same value as in {@code Types} for the data type.
	 */
